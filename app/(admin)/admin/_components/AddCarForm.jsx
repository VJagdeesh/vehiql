...
import { addCar, processCarmageWithAI } from "@/actions/cars";
...
const AddCarForm = () => {
  ...
  } = useFetch(processCarmageWithAI);

  const {
    fn: addCarFn,
    data: addCarResult,
    isLoading: addCarLoading,
    isSuccess: addCarSuccessfully,
    error: addCarError,
  } = useFetch(addCar);
  ...
  // if (addCarSuccessfully) {
  //   toast.success("car added successfully");
  // }

  // if (addCarError) {
  //   toast.error(addCarError);
  // }
        ...
        <TabsContent value="ai" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an image of car & let AI fill in the details for you
              </CardDescription>
            </CardHeader>
            <CardContent>
